...
public class LoopStatement {
    ...
    public LoopStatement(ParseTree ctx, Map<String, Value> memory, Map<String, Functions> functionMap, customVisitor context, mainInterface frame){
        ...
        customVisitor visitor = new customVisitor(tempMemory, functionMap, frame);
